...
FILES=$(find "$SRC" -type f \( -name '*.ts' -o -name '*.js' \) ! -path '*/generated/*')
...
# 2. URL de instancia
URLS=$(grep -rniE 'https?://[a-z0-9._-]+\.(service-now|servicenow)\.com' "$PKG" \
